		...
		document.querySelector('.sidebar__close button.navigate-back').addEventListener('click', e=>{
			...
			e.preventDefault();
				...
				if ( submenuLevel == 1 ) {
		 			...
		 			submenuLevel = 1;
		 			sidebarMenus.querySelector('. .opened').parentElement.classList.remove('opened');
		 			sidebarMenus.querySelector('. .opened').parentElement.parentElement.classList.remove('opened');
		 			sidebarMenus.querySelector('. .opened').classList.remove('opened');
		 		}
